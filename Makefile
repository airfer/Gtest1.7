...
ACLOCAL = ${SHELL} /temp/gtest-1.7.0/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /temp/gtest-1.7.0/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /temp/gtest-1.7.0/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /temp/gtest-1.7.0/build-aux/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /temp/gtest-1.7.0/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.7.0
abs_builddir = /temp/gtest-1.7.0
abs_srcdir = /temp/gtest-1.7.0
abs_top_builddir = /temp/gtest-1.7.0
abs_top_srcdir = /temp/gtest-1.7.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /temp/gtest-1.7.0/build-aux/install-sh
